...
::callout{type="info" icon="i-lucide-zap"}
**Prerequisites:** Make sure you've read [Core Concepts](/core-concepts) and understand the [Heist Pipeline](/heist-pipeline) before diving into advanced topics.
::