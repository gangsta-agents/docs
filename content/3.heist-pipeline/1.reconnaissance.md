...
5. **Gather requirements** — Understand what you (the Don) actually want, not just what was said
...
In Autonomous Mode (started via `/gangsta:heist`), the Don Proxy approves the Dossier once it's produced and auto-advances to The Grilling. The Heist halts if the Don Proxy detects a Constitutional Floor violation or material incompleteness. [Full Autonomous Mode docs →](/advanced/autonomous-mode)
